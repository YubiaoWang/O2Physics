...
struct JetChargedV2 {
  ...
  // using JetCollisionsMCDWithQvectors = soa::Join<aod::JetCollisionsMCD, aod::BkgChargedMcRhos, aod::Qvectors>;
  ...
  void fitFnc(U const& collision, T const& tracks, J const& jets, double leadingJetEta)
  {
    double ep2 = 0.;
    double ep3 = 0.;
    int cfgNmodA = 2;
                         ...
                         aod::JetTracks const&)
  {
    ...
    //=====================< evt pln [n=2->\Psi_2, n=3->\Psi_3] >=====================//
    fillInOutjetV2EP(collision, jets);
  }
                      ...
                      aod::JetTracks const& tracks)
  {
    ...
    fitFnc(collision, tracks, jets, leadingJetEta);
