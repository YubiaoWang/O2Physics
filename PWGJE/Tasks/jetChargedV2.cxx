...
//rho test
    ...
    registry.add("h2_phi_rho", "#varphi vs #rho(#varphi); #varphi - #Psi_{EP,2};  #rho(#varphi) ", {HistType::kTH2F, {{40, 0., o2::constants::math::TwoPI}, {210, -10.0, 200.0}}});
    ...
    registry.add("h2_phi_rhomedian", "#varphi vs #rho(#varphi); #varphi - #Psi_{EP,2};  #rho(#varphi) ", {HistType::kTH2F, {{40, 0., o2::constants::math::TwoPI}, {210, -10.0, 200.0}}});

    registry.add("h2_phi_rholocal_RC", "#varphi vs #rho(#varphi); #varphi - #Psi_{EP,2};  #rho(#varphi) ", {HistType::kTH2F, {{40, 0., o2::constants::math::TwoPI}, {210, -10.0, 200.0}}});
    registry.add("h2_phi_rhomedian_RC", "#varphi vs #rho(#varphi); #varphi - #Psi_{EP,2};  #rho(#varphi) ", {HistType::kTH2F, {{40, 0., o2::constants::math::TwoPI}, {210, -10.0, 200.0}}});


    registry.add("h2_phi_rholocal_cent", "#varphi vs #rho(#varphi); #cent;  #rho(#varphi) ", {HistType::kTH2F, {{100, 0., 100}, {210, -10.0, 200.0}}});
    registry.add("h2_phi_rhomedian_cent", "#varphi vs #rho(#varphi); #cent;  #rho(#varphi) ", {HistType::kTH2F, {{100, 0., 100}, {210, -10.0, 200.0}}});
    ...
    for (uint i = 0; i < cfgnMods->size(); i++) {
      ...
      for (auto const& jet : jets) {
        ...
        if (nmode == 2) {
          ...
          registry.fill(HIST("h2_phi_rhomedian"), jet.phi() - ep2, collision.rho(), 1.0);
    ...
    for (uint i = 0; i < cfgnMods->size(); i++) {
      ...
      // if (nmode == 2) {
        ...
        for (auto const& jet : jets) {
          ...
          registry.fill(HIST("h2_phi_rho"), jet.phi() - ep2, collision.rho(), 1.0);
